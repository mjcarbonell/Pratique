...
export const FreeRoamInstructions = ({ handleStart }) => {
  return (
    <div style={{position: "fixed", top: "0", left: "0", width: "100vw", height: "100vh", background: "rgba(0, 0, 0, 0.8)", display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", color: "white", textAlign: "center", zIndex: 10}}>
      ...
      <p>Instructions: To progress in the game, you need to hold conversations in French with characters like the baker. Walk up to him for a chat to appear! Make sure your responses are more than just 'yes' or 'no' to move on to the next level and earn rewards. You will have 10 sentences to speak!</p>
