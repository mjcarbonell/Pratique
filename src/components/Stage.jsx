...
export function Stage(props) {
  ...
  return (
    <group {...props} dispose={null}>
      <group position={[10.785, 6.536, -2.251]} rotation={[-Math.PI, 0, 0]} scale={0.7}>
        <mesh geometry={nodes.Object_2.geometry} material={materials['Model_0.001']} position={[0, 0, 8.465]} rotation={[0, 0.346, 0]} />
        <mesh geometry={nodes.Object_3.geometry} material={materials['Model_0.001']} position={[0, 0, 8.465]} rotation={[0, 0.346, 0]} />
        <mesh geometry={nodes.Object_4.geometry} material={materials['Model_0.001']} position={[0, 0, 8.465]} rotation={[0, 0.346, 0]} />
        <mesh geometry={nodes.Object_5.geometry} material={materials['Model_1.001']} position={[0, 0, 8.465]} rotation={[0, 0.346, 0]} />
        <mesh geometry={nodes.Object_6.geometry} material={materials['Model_1.001']} position={[0, 0, 8.465]} rotation={[0, 0.346, 0]} />
      </group>
      <group position={[-18.405, 0, -8.466]} rotation={[-Math.PI, -0.971, 0]} scale={0.3}>
        ...
        <mesh geometry={nodes.Object_2001.geometry} material={materials.material_0} />
        <mesh geometry={nodes.Object_3001.geometry} material={materials.material_0} />
        <mesh geometry={nodes.Object_4001.geometry} material={materials.material_0} />
        <mesh geometry={nodes.Object_5001.geometry} material={materials.material_0} />
        <mesh geometry={nodes.Object_6001.geometry} material={materials.material_0} />
      ...
      <mesh geometry={nodes.table_01.geometry} material={materials['Material.021']} position={[-7.539, 0.19, -6.853]} rotation={[0.856, 1.072, 2.439]} scale={[0.057, 0.201, 0.057]}>
        ...
        <mesh geometry={nodes['06'].geometry} material={materials['Material.034']} position={[0.672, -2.165, 1.976]} rotation={[-1.219, -0.441, -0.545]} scale={[9.053, 9.138, 3.078]} />
      </mesh>
      <mesh geometry={nodes.Eiffel.geometry} material={materials['Metal_Steel_Textured.001']} position={[-4.937, 0, -8.553]} scale={0.001} />
    </group>
  )
}
